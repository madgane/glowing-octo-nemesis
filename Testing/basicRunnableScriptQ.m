...
script_cells{xIndex,1}.robustNoise = 0;
script_cells{xIndex,1}.fbFraction = 0.0;
...
script_cells{xIndex,1}.mdpFactor = 0;
script_cells{xIndex,1}.robustNoise = 0;
script_cells{xIndex,1}.fbFraction = 0.30;
...
xIndex = xIndex + 1;%3
script_cells{xIndex,1}.queueWt = 2;
script_cells{xIndex,1}.mdpFactor = 0.9;
script_cells{xIndex,1}.robustNoise = 0;
script_cells{xIndex,1}.fbFraction = 0.30;
...
script_cells{xIndex,1}.queueWt = 2;
script_cells{xIndex,1}.mdpFactor = 2;
script_cells{xIndex,1}.robustNoise = 1;
script_cells{xIndex,1}.fbFraction = 0.30;
...
SimParams.outFile = 'outFile_srs.mat';
pathAddition;
...
for iScript = 1:length(script_cells)
    ...
    SimParams.robustNoise = script_cells{iScript,1}.robustNoise;
    ...
    SimParams.dispString = sprintf('%s-%s-%s-%d',SimParams.SchedType,...
        SimParams.PrecodingMethod,SimParams.weightedSumRateMethod,SimParams.queueWt);
...
%         semilogy(SimParams.maxArrival,mean(squeeze(SimResults.queueBackLogs(end,:,:)),1));
